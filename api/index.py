    ...
    def do_POST(self):
        ...
        try:
            ...
            if "message" in update and update["message"].get("text") == "/start":
                ...
                # Сначала пишем в таблицу (ждем завершения)
                log_user_to_sheet(user_from)
                
                # Потом шлем сообщения
                ...
                p2 = {"chat_id": chat_id, "text": text_main, "reply_markup": {"inline_keyboard": [[{"text": "🌴 Каталог", "url": "https://bndeliveryphuket.click/info"}, {"text": "👤 Оператор", "url": "https://bndeliveryphuket.click/chat"}], [{"text": "📸 Instagram", "url": "https://bndeliveryphuket.click/insta"}, {"text": "🟢 WhatsApp", "url": "https://bndeliveryphuket.click/wa"}]]}, "parse_mode": "Markdown"}
